...
export default function Login() {
  ...
  return (
    <div className="min-h-screen w-full bg-[#0A0E17] text-white flex flex-col items-center justify-center p-6 sm:p-8 lg:p-12 relative overflow-hidden selection:bg-blue-500/30">
      ...
      <div className="absolute inset-0 pointer-events-none overflow-hidden opacity-25">
        <svg className="w-full h-full" xmlns="http://www.w3.org/2000/svg">
          ...
          {/* Ambient Glows */}
          <circle cx="15%" cy="25%" r="400" fill="url(#glow)" />
          <circle cx="85%" cy="75%" r="450" fill="url(#glow)" />

          {/* Synapse Network Paths */}
          <g stroke="url(#lineGrad)" strokeWidth="1" fill="none">
            <path d="M 50 120 Q 350 220 700 160 T 1200 320" />
            <path d="M 120 650 Q 450 450 800 750 T 1400 550" />
            <path d="M 220 320 Q 550 650 950 420 T 1450 220" />
          </g>
      ...
      <div className="relative z-10 w-full max-w-6xl mx-auto flex flex-col items-center space-y-10 lg:space-y-14 my-auto py-8">
        
        {/* SOMA Brand Header */}
        <header className="text-center space-y-2 animate-in fade-in slide-in-from-top-4 duration-700">
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-serif tracking-[0.25em] font-normal text-white">
            SOMA
          </h1>
          <p className="text-xs sm:text-sm font-light tracking-[0.3em] text-neutral-400 uppercase">
        ...
        <div className="w-full grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-10 items-stretch">
          ...
          <div className="lg:col-span-5 bg-neutral-900/60 backdrop-blur-2xl border border-white/10 rounded-3xl p-8 sm:p-10 shadow-2xl shadow-black/60 flex flex-col justify-between relative overflow-hidden group">
            ...
            <div className="space-y-8">
              ...
              <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-blue-500/25 via-cyan-500/10 to-transparent border border-blue-400/30 flex items-center justify-center relative shadow-xl shadow-blue-500/15">
                <div className="absolute inset-0 rounded-2xl bg-blue-500/15 blur-lg"></div>
            ...
            <div className="space-y-6 pt-10">
              {errorMessage && (
                <div className="p-4 bg-red-950/70 border border-red-500/30 text-red-200 text-xs rounded-2xl leading-relaxed">
                  {errorMessage}
                </div>
              )}
              ...
              <button
                onClick={handleLogin}
                disabled={loading}
                className="w-full group/btn relative overflow-hidden rounded-2xl bg-white/10 hover:bg-white/15 border border-white/15 hover:border-blue-400/50 text-white font-medium py-4 px-6 transition-all duration-300 shadow-xl shadow-black/30 flex items-center justify-center gap-3.5 active:scale-[0.98] disabled:opacity-50"
              >
                ...
                <img src="https://www.gstatic.com/firebasejs/ui/2.0.0/images/auth/google.svg" alt="Google" className="w-5 h-5 relative z-10 shrink-0" />
          ...
          <div className="lg:col-span-7 bg-neutral-900/40 backdrop-blur-xl border border-white/10 rounded-3xl p-8 sm:p-10 shadow-2xl shadow-black/50 flex flex-col justify-between relative overflow-hidden">
            ...
            <div className="py-8 sm:py-10 flex flex-col items-center justify-center relative">
              ...
              <svg className="absolute inset-0 w-full h-full pointer-events-none opacity-40 hidden sm:block" xmlns="http://www.w3.org/2000/svg">
                <line x1="50%" y1="45%" x2="20%" y2="25%" stroke="#3b82f6" strokeWidth="1.5" strokeDasharray="4 4" />
                <line x1="50%" y1="45%" x2="80%" y2="25%" stroke="#06b6d4" strokeWidth="1.5" strokeDasharray="4 4" />
                <line x1="50%" y1="45%" x2="50%" y2="85%" stroke="#6366f1" strokeWidth="1.5" strokeDasharray="4 4" />
              </svg>

              {/* Central Study OS Hub */}
              <div className="relative z-10 w-28 h-28 sm:w-32 sm:h-32 rounded-3xl bg-gradient-to-br from-blue-600/30 to-indigo-900/60 border border-blue-400/40 backdrop-blur-2xl flex flex-col items-center justify-center p-4 shadow-2xl shadow-blue-500/25 group hover:scale-105 transition-transform duration-500">
              ...
              <div className="w-full grid grid-cols-1 sm:grid-cols-3 gap-4 pt-8 sm:pt-10 relative z-10">
